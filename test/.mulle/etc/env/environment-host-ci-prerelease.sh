...
#
# mulle-testgen nodetype: ${MULLE_TESTGEN_NODETYPE:-tar}
#
export MULLE_TESTGEN_NODETYPE="git"


#
# mulle-testgen url: ${MULLE_TESTGEN_URL:-https://github.com/MulleFoundation/mulle-testgen/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_TESTGEN_URL="https://github.com/MulleFoundation/mulle-testgen.git"


#
# mulle-testgen branch: ${MULLE_TESTGEN_BRANCH}
#
export MULLE_TESTGEN_BRANCH="prerelease"
